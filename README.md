...
| :--- | :---------- | :--- | ----: | :------ |
| [claw-code](https://github.com/jxoesneon/claw-code) (fork) | The fastest repo in history to surpass 50K stars ⭐, reaching the milestone in just 2 hours after publication. Better Harness Tools, not merely storing the archive of leaked Claude Code but make real things done. Now rewriting in Rust using oh-my-codex. |  | 0 | 2026-04-01 |
...
| [jxoesneon](https://github.com/jxoesneon/jxoesneon) | Personal profile for Jose Eduardo Rojas Jimenez | Python | 0 | 2026-03-31 |
